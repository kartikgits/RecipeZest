...
public class EdamamRecipeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<EdamamRecipe>> {

    private static final String LOG_TAG = "EdamamRecipeActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        recipeCategory = getIntent().getStringExtra("recipeCategory");
        DHLabel = getIntent().getStringExtra("DHLabel");
    ...
    public Loader<List<EdamamRecipe>> onCreateLoader(int id, Bundle args) {
        ...
        completeEUrl = eRequestUrlQuery + RandomsGenerator.getRandomAlphabet();
        if (DHLabel.equals("health")) {
            completeEUrl += eRequestUrlHealthLabel + recipeCategory;
        } else {
            completeEUrl += eRequestUrlDietLabel + recipeCategory;
        }
